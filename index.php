...
<head>
    <title>Smart Traffic Fine Management System</title>

    <!--Meta tags start-->
    <meta charset="UTF-8">
    <meta name="description" content="Smart Traffic Fine Management System">
    <meta name="keywords" content="Traffic, Fine, System">
    ...
    <div class="topnavbar animated fadeIn">
        ...
        <ul class="topnavbar-nav">
            <li class="topnav-item">
                <a href="index.php"><img class="footer-logo" src="assets/img/footer_logo.svg" alt="STFMS logo" class="logo logo-light"></a> 
                        ...
                        <div class="container">
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6 animated bounceInUp custom-slide-animi">
                                    <div class="img-box">
                                        <img src="assets/img/slide_04.svg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6 animated bounceInDown custom-slide-animi">
                                    <div class="img-box">
                                        <img src="assets/img/slide_01.svg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item ">
                        <div class="container">
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6 animated bounceInUp custom-slide-animi">
                                    <div class="img-box">
                                        <img src="assets/img/slide_02.svg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item ">
                        <div class="container">
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6 animated bounceInDown custom-slide-animi">
                                    <div class="img-box">
                                        <img src="assets/img/slide_03.svg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container animated fadeIn">
                <div class="row">
                    <div class="footer-col">
                        ...
                        <ul>
                            <li><a href="tel:+917386973639"><i class="fas fa-phone"></i> +91 7386973639</a></li>
                        </ul>
                    </div>
                    <div class="footer-col">
                        <h4>Inquiry via email</h4>
                        <ul>
                            <li><a style="text-transform: lowercase;" href="mailto:trafficmgmt@gmail.com" target="_blank"> <i class="fas fa-envelope"></i>trafficmgmt@gmail.com</a></li>
                        </ul>
                    </div>
                    <div class="footer-col">
                        <h4>Other Links</h4>
